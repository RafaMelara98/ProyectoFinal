...
public class Ingresos extends javax.swing.JFrame {
    ...
    public Ingresos(int idcategoria){
...
//                BigDecimal decimal = new BigDecimal(txtDinero.toString());
                ...
                if(userDao.Operacion(idcategoria,userDao.obteneridCuenta(jComboBox1.getSelectedItem().toString()),1,Cuenta.obtnerIdUsuario(user.getUsername()),BigDecimal.valueOf(dinero),sDate,"nada")){
