...
public class CambiarContraseña extends javax.swing.JFrame {
     ...
     */
    public CambiarContraseña(JFrame window) {
        initComponents();
        this.window = window;
        user2 = new User();
        user = new Usuario();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(txtUsuario.getText().isEmpty() || txtContraseña.getText().isEmpty()){
            ...
            if(user2.cambiarContraseña(user)){
                JOptionPane.showMessageDialog(this,"Se ha actualizado correctamente la contraseña","Success",JOptionPane.INFORMATION_MESSAGE);
                setVisible(false);
                window.setVisible(true);
            }
        }
